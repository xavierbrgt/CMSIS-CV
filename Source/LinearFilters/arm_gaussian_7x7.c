...
#define HORIZONTAL_COMPUTE_SCALAR(data_0, data_1, data_2, data_3, data_4, data_5, data_6)                              \
    DIV_256((KERNEL_APPLICATION(data_0, data_1, data_2, data_3, data_4, data_5, data_6)))
...
#define VERTICAL_COMPUTE_VECTOR(vect_1, vect_2, vect_3, vect_4, vect_5, vect_6, vect_7, vect_res)                      \
    ...
    vect_2x2.val[0] = vshllbq(vect_4, 1);                                                                              \
    vect_2x2.val[0] = vmulq(vect_2x2.val[0], 9);                                                                       \
    vect_res.val[0] = vaddq(vect_res.val[0], vect_2x2.val[0]);                                                         \
    ...
    vect_2x2.val[1] = vshlltq(vect_4, 1);                                                                              \
    vect_2x2.val[1] = vmulq(vect_2x2.val[1], 9);                                                                       \
    vect_res.val[1] = vaddq(vect_res.val[1], vect_2x2.val[1]);                                                         \
    ...
    vect_2x2.val[1] = vmulq(vect_2x2.val[1], 7);                                                                       \
    vect_res.val[1] = vaddq(vect_res.val[1], vect_2x2.val[1]);                                                         \
    vect_res.val[0] = vshrq(vect_res.val[0], 4);                                                                       \
    vect_res.val[1] = vshrq(vect_res.val[1], 4);
...
#define HORIZONTAL_COMPUTE_VECTOR(vect_1, vect_2, vect_3, vect_4, vect_5, vect_6, vect_7, vect_out)                    \
    ...
    vect_2.val[1] = vaddq_s16(vect_2.val[1], vect_3.val[1]);                                                           \
    vect_out = vshrnbq(vect_out, vect_2.val[0], 8);                                                                    \
    vect_out = vshrntq(vect_out, vect_2.val[1], 8);
