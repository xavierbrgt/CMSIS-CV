...
#define HORIZONTAL_COMPUTE_SCALAR_GAUSSIAN(data_0, data_1, data_2)                                                     \
    ((data_0 * 0x08 + (data_1 * 0x10) + data_2 * 0x08) >> 10)

#if defined(ARM_MATH_MVEI) && !defined(ARM_MATH_AUTOVECTORIZE)

/*__STATIC_FORCEINLINE int16x8x2_t VerticalCompute(uint8x16_t vect_1, uint8x16_t
vect_2, uint8x16_t vect_3);
__STATIC_FORCEINLINE int8x16_t HorizonCompute(int16x8x2_t vect_1, int16x8x2_t
vect_2, int16x8x2_t vect_3);*/
#define VERTICAL_COMPUTE_VECTOR_GAUSSIAN_1(vect_1, vect_2, vect_3)                                                     \
...
#define VERTICAL_COMPUTE_VECTOR_GAUSSIAN_2(vect_1, vect_2, vect_3, vect_res)                                           \
    int16x8x2_t vect_1x2;                                                                                              \
    int16x8x2_t vect_3x2;                                                                                              \
    vect_1x2.val[0] = vshllbq(vect_1, 3);                                                                              \
    vect_3x2.val[0] = vshllbq(vect_3, 3);                                                                              \
